# Contributing to schema-org-validator

Thank you for your interest and efforts to contribute to schema-org-validator. All work done is available on GitHub.
...
schema-org-validator is using [GitHub issues](https://github.com/webdevbynight/schema-org-validator/issues) to manage feature requests and bugs. Before opening an issue or a pull request, try to ensure your problem or feature request has not been already reported or fixed.

### Feature requests

Feature requests by the community are highly encouraged. Feel free to submit a new one filling the information requested in the [feature request template](https://github.com/webdevbynight/schema-org-validator/issues/new?template=feature-request.yml).

### Bug reports

Please try to be as detailed as possible in your report and fill the information requested in the [bug report template](https://github.com/webdevbynight/schema-org-validator/issues/new?template=bug-report.yml).
...
- you have [pnpm](https://pnpm.io) at version 10.30.3+ installed,
...
#### Steps
1. [Go to the repository](https://github.com/webdevbynight/schema-org-validator) and fork it using your own GitHub account,
2. clone your repository:

        git clone git@github.com:YOUR_USERNAME/schema-org-validator.git
3. go to the root of the repository and run:

        cd schema-org-validator
        pnpm install
4. run TypeScript and the test suites in watch mode:

        pnpm dev

Awesome! You are now able to contribute to schema-org-validator.
...
schema-org-validator follows the rules defined by the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) specification.
...
schema-org-validator uses [commitlint](https://commitlint.js.org) to help you create valid commit messages.
...
schema-org-validator uses [Biome](https://biomejs.dev) for linting and formatting. Biome linting and formatting will be automatically checked and run when committing.
...
schema-org-validator uses [Vitest](https://vitest.dev) for writing and running tests.
